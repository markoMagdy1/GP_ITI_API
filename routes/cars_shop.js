...
router.get("/signup", carsshopAuth.signup_get);
router.post("/signup", carsshopAuth.signup_post);
router.get("/login", carsshopAuth.login_get);
router.post("/login", carsshopAuth.login_post);
router.get("/logout", carsshopAuth.logout_get);
