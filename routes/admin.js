...
router.get("/signup", adminAuth.signup_get);
router.post("/signup", adminAuth.signup_post);
router.get("/login", adminAuth.login_get);
router.post("/login", adminAuth.login_post);
router.get("/logout", adminAuth.logout_get);
