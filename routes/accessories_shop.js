...
const accessshopAuth = require("../controllers/accessshopAuth");
...
router.get("/signup", accessshopAuth.signup_get);
router.post("/signup", accessshopAuth.signup_post);
router.get("/login", accessshopAuth.login_get);
router.post("/login", accessshopAuth.login_post);
router.get("/logout", accessshopAuth.logout_get);
